...
class CNN(nn.Module):
    def __init__(self, dropout_prob, maxpool=True, conv_bias=True):
        ...
        self.fc1 = nn.Linear(channels[3] * 6 * 6, fc1_out_dim)  # After conv and pooling
        self.fc2 = nn.Linear(fc1_out_dim, fc2_out_dim)
        self.fc3 = nn.Linear(fc2_out_dim, 10)  # Number of classes
